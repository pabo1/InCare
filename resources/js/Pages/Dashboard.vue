...
<template>
    ...
    >
        <section class="grid items-start gap-4 xl:grid-cols-[minmax(0,1.45fr)_minmax(20rem,0.85fr)]">
            <div class="crm-panel crm-accent-card p-6 sm:p-7">
            ...
            <div class="crm-panel p-6 sm:p-7">
        ...
        <div class="mt-6 grid gap-6 2xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_22rem]">
            <section class="space-y-4">
                ...
                <div v-if="recentLeads.length" class="grid gap-4 md:grid-cols-2">
            ...
            <section class="space-y-4">
                ...
                <div v-if="upcomingDeals.length" class="grid gap-4 md:grid-cols-2">
